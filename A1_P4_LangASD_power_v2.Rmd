...
sim1 = createNewData(100, 6, fav_model)
...
td15 = data.frame(td, subj_id ==  1, 3, 8, 9, 10, 11, 12, 13, 14, 15, 16, 18, 22, 25, 27)
View(td15)
...
fav_model_30kids  = lmer(CHI_MLU ~ Diagnosis + Visit +(1+ Visit|subj_id), kids, REML = F)
summary(fav_model_30kids)
